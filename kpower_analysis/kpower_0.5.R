# kpower power assessment - 0.5 gap threshold dataset
#
# Assesses whether "data/0.5_trimmed_alns_HIV_2021_subset.fasta" (columns with
# gaps in >50% of sequences removed) has enough signal to reliably recover the
...
here::i_am("kpower_analysis/kpower_0.5.R")
library(here)
library(kpower)
