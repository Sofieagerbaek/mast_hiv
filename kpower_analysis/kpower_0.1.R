# kpower power assessment - 0.1 gap threshold dataset
#
# Assesses whether "data/0.1_trimmed_alns_HIV_2021_subset.fasta" (columns with
# gaps in >10% of sequences removed) has enough signal to reliably recover the
...
here::i_am("kpower_analysis/kpower_0.1.R")
library(here)
library(kpower)
